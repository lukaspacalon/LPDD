...
with open('personnalite/rival_V.json') as file:
    data = json.load(file)
...
def check(cible_int):
    ...
    while True:
        ...
        if string.lower() == 'aurevoir' :
            ...
            if test_caractere > 50:
                print("Le geste semble avoir eu un effet positif ;)")
                destination.habitants[cible_int].__dict__['relationnel'] = destination.habitants[cible_int].__dict__['relationnel'] - 200
                destination.habitants[cible_int].__dict__['peur'] =  destination.habitants[cible_int].__dict__['peur'] + 150
                destination.habitants[cible_int].__dict__['attirance'] = destination.habitants[cible_int].__dict__['attirance'] + 250
            elif test_caractere < 50 and test_caractere > 25:
                print("Le geste semble ne pas avoir fait d'effet...")
            else:
                print("Le geste semble avoir eu un effet négatif !")
            ...
            print("")
            print("Fous moi la paix avec tes questions à la con")
            print("")
            ...
            print("(la personne vous fait un doigt d'honneur)")
            print("")
            ...
            print("")
            print("réponse :")
            print("Je vous parle actuellement et c'est chiant...")
            print("")
