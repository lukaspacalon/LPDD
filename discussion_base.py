...
with open('personnalite/base_V.json') as file:
    data = json.load(file)
...
def check(cible_int):
    ...
    while True:
        ...
        if string == 'aurevoir' :
            ...
            print(joueur.mon_joueur.charisme)
            test_caractere = random.randint(1, 10)*10 + joueur.mon_joueur.charisme - caractere
            ...
            if test_caractere > 50:
                print("Le geste semble avoir eu un effet positif ;)")
                destination.habitants[cible_int].__dict__['relationnel'] = destination.habitants[cible_int].__dict__['relationnel'] - 15
            ...
            print("")
            print("réponse :")
            print("Nous ne nous connaissons pas encore très bien")
            print("")
