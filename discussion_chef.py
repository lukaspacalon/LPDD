...
with open('personnalite/chef_V.json') as file:
    data = json.load(file)
...
def check(cible_int):
    ...
    while True:
        ...
        if string.lower() == 'aurevoir' :
            ...
            print("")
        elif string.lower() in ["Yy a t-il une construction ici ?", "où puis-je me reposer ?", "où puis-je trouver des gens ?", "où puis-je commercer ?", "où puis-je m'arrêter ?"]:
            print("")
