...
def check(cible_int):
    ...
    while True:
        ...
        if string.lower() == 'aurevoir' :
            ...
            print("")
        elif string.lower() in ['enlacer', "prendre la main", "regarder", "pousser", "clin d'oeil"]:
            print("")
            print("destination.habitants[cible_int].__dict__['personalite']")
            print(destination.habitants[cible_int].__dict__['personalite'])
            if destination.habitants[cible_int].__dict__['personalite'] == "empathique":
            ...
            if test_caractere > 50:
                print("Le geste semble avoir eu un effet positif ;)")
                destination.habitants[cible_int].__dict__['relationnel'] = destination.habitants[cible_int].__dict__['relationnel'] + 150
                destination.habitants[cible_int].__dict__['peur'] =  destination.habitants[cible_int].__dict__['peur'] - 100
                destination.habitants[cible_int].__dict__['attirance'] = destination.habitants[cible_int].__dict__['attirance'] + 25
